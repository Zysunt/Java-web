...
<html>
	...
	<body>
		<form action="${pageContext.request.contextPath }/updateByid" enctype="multipart/form-data" method="post">
			<div id="head">
				<h1>Easy-Car易人租车管理系统</h1>
			</div>
			<div id="content">
				<p>更新车辆</p>
				<input type="hidden" name="idCar" value="<%=request.getParameter("idCar") %>"/>
					<table>
						<tr>
							<td>品牌</td>
							<td>
								<select name="selectbrand" id="option">
						...
						<tr>
							<td>级别</td>
							<td>
								<select name="selectlevel" id="option">
